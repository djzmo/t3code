...
Evidence current on 2026-08-19:
...
| V1.2      | Framing, lifecycle, native process broker, retained process identity, shared Unix host-group cleanup, containment unit tests, and the real `DesktopLifecycle`/`DesktopUpdates` integration proof are implemented.                                                    | Complete the macOS native Quit path and three-OS containment fixtures.                                                                                                                |
